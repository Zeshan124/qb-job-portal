        ...
        <div className="flex space-x-2 items-center">
          ...
          {session && (
            <Link href="/jobposting">
              {" "}
              {/* Replace with the actual path to your JobPosting page */}
          
                {" "}
               
                <button className="px-4 py-1.5 text-[14px] h-[3em] sm:text-[16px] sm:px-6 sm:py-2 bg-orange-600 hover:bg-orange-800 font-semibold text-white rounded-lg transition-colors duration-300">
                  Post a job
                </button>
            </Link>
          )}
