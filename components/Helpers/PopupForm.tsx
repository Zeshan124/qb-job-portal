...
const PopupForm = ({
  ...
  const handleClick = () => {
    ...
    // Simulate loading time with a timeout before navigating
    setTimeout(() => {
      // Redirect to /resume_builder
      window.location.href = "/resume_builder";
    }, 2000); // Set the delay (e.g., 2 seconds)
  };
  return (
    <Modal
      isOpen={isOpen}
      ...
      >
        ...
        <div>
          ...
          {/* <Link href="/resume_builder">
            <button className="bg-indigo-600 text-white p-10">Go to Resume Builder</button>
          </Link> */}
        </div>
