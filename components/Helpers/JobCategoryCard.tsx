...
export const JobCategoryCard = ({ category, image, openPosition }: Props) => {
    return (
        <div className='flex space-x-4 p-4 border-2 cursor-pointer hover:scale-105 hover:shadow-xs transition-transform border-gray-600 rounded-lg border-opacity-20'>
